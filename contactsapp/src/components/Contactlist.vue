        ...
        <table id="list" class="table table-striped table-bordered table-hover">
            ...
            <tbody id="contacts" >
                <tr v-for = "contact in contactlist.contacts">
                    ...
                    <td><button class="btn btn-primary" @click="updateContact(contact.no)">편집하기</button></td>
                    <td><button class="btn btn-primary" @click="deleteContact(contact.no)">삭제하기</button></td>
                </tr>
            </tbody>
        </table>
        </div>
...
export default {
    ...
    methods: {
        addContact: function() {
            this.$store.dispatch(Constants.ADD_FORM);
        },
        updateContact: function(no) {
            this.$store.dispatch(Constants.UPDATE_FORM, {no: no});
        },
